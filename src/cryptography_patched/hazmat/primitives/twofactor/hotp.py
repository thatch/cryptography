...
from cryptography_patched.hazmat.primitives import constant_time, hmac
from cryptography_patched.hazmat.primitives.hashes import SHA1, SHA256, SHA512
from cryptography_patched.hazmat.primitives.twofactor import InvalidToken
from cryptography_patched.hazmat.primitives.twofactor.utils import _generate_uri
