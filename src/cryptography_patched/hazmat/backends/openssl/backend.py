...
from cryptography_patched.hazmat.backends.openssl import aead
from cryptography_patched.hazmat.backends.openssl.ciphers import _CipherContext
from cryptography_patched.hazmat.backends.openssl.cmac import _CMACContext
from cryptography_patched.hazmat.backends.openssl.decode_asn1 import (
    _CRL_ENTRY_REASON_ENUM_TO_CODE
)
from cryptography_patched.hazmat.backends.openssl.dh import (
    _DHParameters, _DHPrivateKey, _DHPublicKey, _dh_params_dup
)
from cryptography_patched.hazmat.backends.openssl.dsa import (
    _DSAParameters, _DSAPrivateKey, _DSAPublicKey
)
from cryptography_patched.hazmat.backends.openssl.ec import (
    _EllipticCurvePrivateKey, _EllipticCurvePublicKey
)
from cryptography_patched.hazmat.backends.openssl.ed25519 import (
    _Ed25519PrivateKey, _Ed25519PublicKey
)
from cryptography_patched.hazmat.backends.openssl.ed448 import (
...
from cryptography_patched.hazmat.backends.openssl.hashes import _HashContext
from cryptography_patched.hazmat.backends.openssl.hmac import _HMACContext
from cryptography_patched.hazmat.backends.openssl.ocsp import (
    _OCSPRequest, _OCSPResponse
)
from cryptography_patched.hazmat.backends.openssl.poly1305 import (
    _POLY1305_KEY_SIZE, _Poly1305Context
)
from cryptography_patched.hazmat.backends.openssl.rsa import (
    _RSAPrivateKey, _RSAPublicKey
)
from cryptography_patched.hazmat.backends.openssl.x25519 import (
    _X25519PrivateKey, _X25519PublicKey
)
from cryptography_patched.hazmat.backends.openssl.x448 import (
...
from cryptography_patched.hazmat.primitives.asymmetric.padding import (
...
from cryptography_patched.hazmat.primitives.ciphers.modes import (
    CBC, CFB, CFB8, CTR, ECB, GCM, OFB, XTS
)
from cryptography_patched.hazmat.primitives.kdf import scrypt
