...
from cryptography_patched.x509 import certificate_transparency
from cryptography_patched.x509.base import (
...
from cryptography_patched.x509.extensions import (
...
from cryptography_patched.x509.general_name import (
    DNSName, DirectoryName, GeneralName, IPAddress, OtherName, RFC822Name,
    RegisteredID, UniformResourceIdentifier, UnsupportedGeneralNameType,
    _GENERAL_NAMES
)
from cryptography_patched.x509.name import (
